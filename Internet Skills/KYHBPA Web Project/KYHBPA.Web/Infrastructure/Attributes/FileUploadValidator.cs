        ...
        : ValidationAttribute, IClientValidatable
    {
            ...
            , ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                if (_minimumFileSizeValidator != null)
                {
                    ...
                    {
                        errorMessage.Append($"{_minimumFileSizeValidator.FormatErrorMessage(validationContext.DisplayName)}. ");
                    }
                }
                ...
                if (_maximumFileSizeValidator != null)
                {
                    ...
                    {
                        errorMessage.Append($"{_maximumFileSizeValidator.FormatErrorMessage(validationContext.DisplayName)}. ");
                    }
                }
                ...
                if (_validFileTypeValidator != null)
                {
                    ...
                    {
                        errorMessage.Append($"{_validFileTypeValidator.FormatErrorMessage(validationContext.DisplayName)}. ");
                    }
                }
            ...
            , ControllerContext context)
        {
            ...
            if (_minimumFileSizeValidator != null)
            {
                ...
                parameters.Add(_minimumFileSizeValidator.MinimumFileSize.ToString(CultureInfo.CurrentCulture));
            ...
            if (_maximumFileSizeValidator != null)
            {
                ...
                parameters.Add(_maximumFileSizeValidator.MaximumFileSize.ToString(CultureInfo.CurrentCulture));
